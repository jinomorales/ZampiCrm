...
<div class="card-body">
    <div>
        <h2 class="mb-3 f-w-600"><?php echo e(__('Ingreso')); ?></h2>
    </div>
    <?php if(session('status')): ?>
    <div>
        <div class="mb-4 font-medium text-lg text-green-600 text-danger">
            <?php echo e(__('Su cuenta está deshabilitada, comuníquese con su administrador')); ?>
...
unset($__errorArgs, $__bag); ?>" name="email" placeholder="<?php echo e(__('Ingresar correo')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="my-4 text-center"><?php echo e(__("¿No tienes una cuenta?")); ?>

            <a href="<?php echo e(route('register', $lang)); ?>" tabindex="0"><?php echo e(__('Registrarse')); ?></a>
        </p>
        <?php endif; ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u265718333/domains/zampisoft.com/public_html/ZampiCrm/resources/views/auth/login.blade.php ENDPATH**/ ?>