                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary" class="" name="testimonials_status" id="testimonials_status" <?php echo e($settings['testimonials_status'] == 'on' ? 'checked="checked"' : ''); ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u265718333/domains/zampisoft.com/public_html/ZampiCrm/Modules/LandingPage/Resources/views/landingpage/testimonials/index.blade.php ENDPATH**/ ?>