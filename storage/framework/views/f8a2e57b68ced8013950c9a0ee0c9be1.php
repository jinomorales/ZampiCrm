            ...
            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6">
               ...
               ">
                    <div class="card-body <?php echo e(!empty(\Auth::user()->type != 'super admin') ? 'plan-box' : ''); ?>"
                        ...
                        <p class="mb-0">
                            <?php echo e(__('Días de prueba : ') . __($plan->trial_days ? $plan->trial_days : 0)); ?><br />
                        </p>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u265718333/domains/zampisoft.com/public_html/ZampiCrm/resources/views/plan/index.blade.php ENDPATH**/ ?>